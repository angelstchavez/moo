...
class AddAnimal extends StatefulWidget {
  ...
  const AddAnimal({Key? key, required this.finca, required this.lote,required this.dataLenght}) 
      : super(key: key);
...
class _AddAnimalState extends State<AddAnimal> {
  ...
  content: SingleChildScrollView(
    child: Container(
      constraints: BoxConstraints(maxWidth: 400), // Establece el tamaño máximo del formulario
      ...
      onPressed: () async {
        if (_formKey.currentState!.validate()) {
          ...
          await addAnimal(_nombreController.text, _razaController.text,
            ...
            updateBatchLenght(widget.lote,widget.dataLenght+1);// Cierra el diálogo
          });
